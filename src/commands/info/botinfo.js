...
module.exports = class BotInfoCommand extends Command {
  constructor(client) {
    super(client, {
      ...
      aliases: ['bot', 'bi'],
      usage: 'botinfo',
      description: 'Fetches PunX_System bot information.',
  ...
  run(message) {
    ...
    const embed = new MessageEmbed()
      .setTitle('PunX_System Bot Information')
      .setDescription(oneLine`
        PunX_System is an open source, fully customizable Discord bot that is constantly growing.
      ...
      .setImage('https://i.imgur.com/gwoLTim.png')
